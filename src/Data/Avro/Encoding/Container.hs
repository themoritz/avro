...
import           Data.Avro.Encoding.ToEncoding   (ToEncoding, toEncoding)
...
encodeContainer :: ToEncoding a => Codec -> Schema -> [[a]] -> IO BL.ByteString
...
encodeContainerWithSync :: ToEncoding a => Codec -> Schema -> BL.ByteString -> [[a]] -> BL.ByteString
